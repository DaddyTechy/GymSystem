        ...
        Try
            ...
            If result = DialogResult.Yes Then
                ...
                AddHandler paymentControl.btnSave.Click, Sub(sender As Object, e As EventArgs)
                                                             ...
                                                             Dim queryPayment As String = $"INSERT INTO payment (MemberID, MembershipCost,ReservationFee, PaymentMethod, PaymentDate, Amount, InvoiceNumber, ReceiptNumber, DiscountApplied, TaxAmount, TotalAmount, PaymentNotes, PaymentStatus,  MembershipID) " &
                                                                                          $"VALUES ({memberID},'0','{subTotal}', '{paymentMethod}', '{paymentDate:yyyy-MM-dd}', {subTotal}, '{invoiceNumber}', '{receiptNumber}', {discountApplied}, {taxAmount}, {totalAmount}, '{paymentNotes}', 'Paid', '{selectedMember.MemberID}')"
